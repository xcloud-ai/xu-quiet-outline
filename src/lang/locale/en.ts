...
export default {
    ...
    setting_header_desc:
        "Renders an outline tree in the sidebar: click to jump, two-way scroll/cursor locate, level slider, drag to restructure headings, wikilink coloring and style customization.",
    ...
    // Unified settings keys (2026-09-23 house style)
    setting_language: "UI Language",
    setting_language_desc: "Select the display language for the settings panel",
    ...
    setting_docs_desc: "View the full manual on GitHub",
    btn_github: "GitHub",
};